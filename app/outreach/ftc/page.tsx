...
export default function FtcOutreachPage() {
  return (
    <main className="site-grid min-h-screen bg-gray-50 text-gray-950">
      <section className="relative overflow-hidden border-b border-gray-200 bg-white">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <h1 className="display-font mt-2 text-4xl font-black sm:text-5xl">FTC Teams</h1>
          <p className="mt-4 max-w-3xl text-base leading-7 text-gray-600">
            MAGNAtech supports FIRST Tech Challenge teams in our community as they compete in the current season.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-5 md:grid-cols-2">
          <div className="rounded border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-2 text-2xl font-black">35792 &amp; 35794</p>
          </div>
          <div className="rounded border border-gray-200 bg-white p-6 shadow-sm">
            <p className="text-sm font-bold uppercase tracking-wide text-red-700">Current Game</p>
            <p className="mt-2 text-2xl font-black">BIOBUZZ</p>
          </div>
        </div>
        ...
        >
          FTC Team Documentation <ExternalLink size={16} />
        </a>
      </section>
    </main>
  );
